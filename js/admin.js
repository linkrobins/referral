    ...
    content() {
      ...
      if (self._refCodes === undefined && !self._refCodesLoading) {
        ...
        app
          ...
          .then(function (res) {
            self._refCodes = (res && res.data) || [];
            self._refCodesLoading = false;
            m.redraw();
          })
          .catch(function () {
            self._refCodes = [];
      ...
      var selectedGroups;
      try {
        selectedGroups = JSON.parse(setting('eligibility_groups') || '[]');
      } catch (e) {
        selectedGroups = [];
      }
      ...
      function toggleGroup(id) {
        ...
        if (idx === -1) selectedGroups.push(id);
        else selectedGroups.splice(idx, 1);
      ...
      function deleteCode(id) {
        ...
        self._refDeleting = id;
        m.redraw();
        app
          .request({ method: 'DELETE', url: apiBase() + '/referral/campaign-codes/' + id })
          .then(function () {
            self._refCodes = (self._refCodes || []).filter(function (c) {
              return c.id !== id;
            });
      ...
      var eligibilitySection = m(
        ...
        m(
          ...
          m('div', { className: 'Form-group' }, m('label', trans('eligibility.min_posts_label')), numberInput('eligibility_min_posts')),

          m('div', { className: 'Form-group' }, m('label', trans('eligibility.min_age_label')), numberInput('eligibility_min_age_days')),
          ...
          m(
            ...
            m(
              ...
              m('input', {
                ...
                oninput: function (e) {
                  self._refNewLabel = e.target.value;
                },
              })
            ),
            m(
              ...
              m('input', {
                ...
                onchange: function (e) {
                  self._refNewExpiry = e.target.value;
                },
              })
            ),
            m(
      ...
      return m(
        ...
        m('div', { className: 'container ReferralAdmin' }, generalSection, eligibilitySection, campaignSection)
      );
    }
  }
